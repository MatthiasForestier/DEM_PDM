...
bool GeometryHelper::intersectLineAndPlane3D(const Vector3F &point, const Vector3F &line, const Vector4F &plane, F &t) {
...
bool GeometryHelper::pointInTriangle3D(const Vector3F &point, const Vector3F &v0, const Vector3F &v1,
    ...
    F denominator = uv * uv - uu * vv;
    F s = (uv * wv - vv * wu) / denominator;
    F t = (uv * wu - uu * wv) / denominator;
